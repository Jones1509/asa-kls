  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell: "text-muted-foreground rounded-md flex-1 font-medium text-[0.75rem] uppercase tracking-wide",
        ...
        day: cn(
          ...
          "h-9 w-full p-0 font-normal aria-selected:opacity-100 rounded-lg hover:bg-muted/60 transition-colors",
        ),
